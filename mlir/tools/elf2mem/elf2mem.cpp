...
// is a thin CLI wrapper around it. It is the last step of the HiSEP-Q
// pipeline: `qcc --compile-to=native --binary` emits an object file, `ld`
// links it against mlir/tools/loader/hisepq.ld into an ELF, and elf2mem turns
// that ELF into the .mem image (see mlir/tools/loader/README.md).
//
// ===----------------------------------------------------------------------===//
