// RUN: qcc --target=hisepq --min-vlen=128 --compile-to=mlir %s | FileCheck %s
// RUN: qcc --target=hisepq --min-vlen=128 --compile-to=native %s | FileCheck %s --check-prefix=CHECK-ASM
