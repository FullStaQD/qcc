...
func.func @bad_arg_type(%q: !prelimhlep.lin<i1>) -> !prelimhlep.lin<i1> {
...
func.func @bad_result_count(%q: !prelimhlep.lin<i1>) -> !prelimhlep.lin<i1> {
...
func.func @bad_delinearized_result_type(%q: !prelimhlep.lin<i1>) -> !prelimhlep.lin<i64> {
    ...
    }) : (!prelimhlep.lin<i1>) -> !prelimhlep.lin<i64>
