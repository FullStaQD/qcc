// RUN: qcc-opt %s -convert-qco-to-hisepq --split-input-file | FileCheck %s
...
// CHECK:         %[[A1:.*]] = hisepq.single h %[[A0]] : vector<1x!qco.qubit>
// CHECK:         %[[A2:.*]] = vector.extract %[[A1]][0] : !qco.qubit from vector<1x!qco.qubit>

// CHECK:         %[[A3:.*]] = vector.from_elements %[[A2]] : vector<1x!qco.qubit>
// CHECK:         hisepq.single x %[[A3]]
// CHECK:         vector.extract

// CHECK:         hisepq.single y
// CHECK:         hisepq.single z
// CHECK:         hisepq.single s
// CHECK:         hisepq.single sdg
// CHECK:         hisepq.single t
// CHECK:         hisepq.single tdg
// CHECK:         hisepq.single i
...
// CHECK:         %[[C1:.*]], %[[T1:.*]] = hisepq.pair cx %[[C0]], %[[T0]] : vector<1x!qco.qubit>
...
// CHECK:         hisepq.pair cy
// CHECK:         hisepq.pair cz
...
// CHECK:         %[[A1:.*]], %[[B1:.*]] = hisepq.pair iswap %[[A0]], %[[B0]] : vector<1x!qco.qubit>
...
// CHECK:         %[[A1:.*]], %[[BITS:.*]] = hisepq.mz %[[A0]] : vector<1x!qco.qubit> -> vector<1xi1>
// CHECK-DAG:     %[[A2:.*]] = vector.extract %[[A1]][0] : !qco.qubit from vector<1x!qco.qubit>
